...
class ThemeData(models.TransientModel):
    ...
    def icon_change_theme_default(self):
        ...
        for menu in menu_item:
            ...
            if menu.name == 'To-do':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons/to-do.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Knowledge':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons/knowledge.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Payroll':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons/payroll.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'LLM':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons/llm.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Inventory':
                img_path = odoo.tools.misc.file_path(
                ...
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Job Queue':
                img_path = odoo.tools.misc.file_path(
                    'vista_backend_theme/static/src/img/icons/job-queue.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'BI Dashboard':
                img_path = odoo.tools.misc.file_path(
